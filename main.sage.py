...
# reads and encrypts plain_txt using the alphabetic transposition cipher and key and writes the output to the file cipher_txt.  A dictionary will be useful.
def enc_trans(key,plain_txt, cipher_txt):
    return

# reads and decrypts cipher_txt using the alphabetic transpositon cipher and key and writes the output to the file plain_txt
